...
public class TokenUtils {
    ...
    public static String generate30minTokenString() {
        String kid = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
        ...
        try {
            return generateTokenString(kid, timeClaims);
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
     ...
     */
    public static String generateTokenString(String kid, Map<String, Long> timeClaims) throws Exception {
        // Use the test private key associated with the test public key for a valid
        // signature
        PrivateKey pk = readPrivateKey("/privateKey.pem");
        return generateTokenString(pk, kid, timeClaims);
    }
    ...
    public static String generateTokenString(PrivateKey privateKey, String kid,
        ...
        map.put("iss", "firebase-adminsdk-866g3@<PROJECT_ID>.iam.gserviceaccount.com");
        map.put("sub", "firebase-adminsdk-866g3@<PROJECT_ID>.iam.gserviceaccount.com");
        map.put("aud", "https://firestore.googleapis.com/");

        JwtClaimsBuilder claims = Jwt.claims(map);
